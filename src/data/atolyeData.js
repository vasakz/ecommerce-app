...
export const atolyelerVerisi = [
  ...
  { id: 'ahsap-zanaat', isim: 'Ahşap Zanaat Evi', kategori: 'Ahşap', lokasyon: 'Bolu', puan: '4.8', degerlendirmeSayisi: 73, avatar: ahsapTahta, heroBanner: ahsapTahta, heroBannerAlt: 'Ahşap Zanaat Evi Atölye', aciklama: 'Doğal dokuyu koruyan el işçiligiyle mutfak ve yaşam ürünleri üreten butik ahşap atölyesi.', hikaye: 'Doğal ahşap damarları korunarak zımpara ve yağlama adımları elle uygulanır, dayanıklı bir kullanım hedeflenir.', teslimat: '2-3 iş günü', kargo: 'Aynı gün', uretim: 'El işçiligi', urunler: [cokSatanlar[2]] },
  { id: '1', isim: 'Hanımeli Atölyesi', kategori: 'Dekorasyon', lokasyon: 'İstanbul, Türkiye', puan: '4.9', degerlendirmeSayisi: 124, avatar: null, heroBanner: null, heroBannerAlt: 'Hanımeli Atölyesi', aciklama: 'Doğal malzemelerle el yapımı dekorasyon ürünleri ve aksesuarlar üretiyoruz. Her ürünümüz bir hikaye taşır.', hikaye: 'Doğal malzemelerle el yapımı dekorasyon ürünleri ve aksesuarlar üretiyoruz. Her ürünümüz bir hikaye taşır.', teslimat: '24-48 saat içinde', kargo: 'Aynı gün', uretim: 'El yapımı', urunler: [] },
]