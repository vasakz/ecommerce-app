...
function UrunKarti({ urun }) {
 ...
 const kartaTikla = () => {
  ...
  <button 
    onClick={sepeteEkle} 
    className="flex items-center gap-1.5 px-3 py-2 rounded-full bg-amber-600 hover:bg-amber-700 text-white transition-colors shadow-md shadow-amber-600/20 group/btn" 
    title="Sepete Ekle"
  >
...
function Sidebar({ aktifFiltre, setAktifFiltre, seciliKategori, setSeciliKategori, setSeciliAltKategori }) {
  ...
  return (
    <aside className="hidden lg:block w-52 flex-shrink-0 sticky top-20 self-start h-fit">
      <Link to="/atolyeler" className="flex items-center gap-2 w-full mb-6 px-3 py-2.5 rounded-md bg-amber-600 text-white text-xs font-bold tracking-widest uppercase hover:bg-stone-900 transition-colors group">
